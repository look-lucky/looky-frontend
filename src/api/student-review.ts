...
export const getGetReviewsUrl = (storeId: number,
  ...
  return stringifiedParams.length > 0 ? `/api/student/stores/${storeId}/reviews?${stringifiedParams}` : `/api/student/stores/${storeId}/reviews`
}
...
export const getGetReviewsQueryKey = (storeId?: number,
    params?: GetReviewsParams,) => {
    return [
    `/api/student/stores/${storeId}/reviews`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getCreateReviewUrl = (storeId: number,) => {
  ...
  return `/api/student/stores/${storeId}/reviews`
}
...
export type createReplyResponse400 = {
  data: SwaggerErrorResponse
  status: 400
}
...
export type createReplyResponseError = (createReplyResponse400 | createReplyResponse404) & {
  headers: Headers;
};

export type createReplyResponse = (createReplyResponseSuccess | createReplyResponseError)

export const getCreateReplyUrl = (storeId: number,
    parentReviewId: number,) => {


  

  return `/api/student/stores/${storeId}/reviews/${parentReviewId}/replies`
}

export const createReply = async (storeId: number,
    parentReviewId: number,
    createReviewRequest: CreateReviewRequest, options?: RequestInit): Promise<createReplyResponse> => {
  
  return customFetch<createReplyResponse>(getCreateReplyUrl(storeId,parentReviewId),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateReplyMutationOptions = <TError = SwaggerErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createReply>>, TError,{storeId: number;parentReviewId: number;data: CreateReviewRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createReply>>, TError,{storeId: number;parentReviewId: number;data: CreateReviewRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createReply>>, {storeId: number;parentReviewId: number;data: CreateReviewRequest}> = (props) => {
          const {storeId,parentReviewId,data} = props ?? {};

          return  createReply(storeId,parentReviewId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateReplyMutationBody = CreateReviewRequest
    export type CreateReplyMutationError = SwaggerErrorResponse

    /**
 * @summary [학생] 리뷰 답글 작성
 */
export const useCreateReply = <TError = SwaggerErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createReply>>, TError,{storeId: number;parentReviewId: number;data: CreateReviewRequest}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getReportReviewUrl = (reviewId: number,) => {
  ...
  return `/api/student/reviews/${reviewId}/reports`
}
...
export const getAddLikeUrl = (reviewId: number,) => {
  ...
  return `/api/student/reviews/${reviewId}/likes`
}
...
export const getDeleteReviewUrl = (reviewId: number,) => {
  ...
  return `/api/student/reviews/${reviewId}`
}
...
export const getGetReviewStatsUrl = (storeId: number,) => {
  ...
  return `/api/student/stores/${storeId}/reviews/stats`
}
...
export const getGetReviewStatsQueryKey = (storeId?: number,) => {
    return [
    `/api/student/stores/${storeId}/reviews/stats`
    ] as const;
    }
...
export const getGetMyReviewsUrl = (params: GetMyReviewsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/student/reviews/my?${stringifiedParams}` : `/api/student/reviews/my`
}
...
export const getGetMyReviewsQueryKey = (params?: GetMyReviewsParams,) => {
    return [
    `/api/student/reviews/my`, ...(params ? [params] : [])
    ] as const;
    }
