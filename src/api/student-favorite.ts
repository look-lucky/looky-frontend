...
export type addFavoriteResponseError = (addFavoriteResponse400 | addFavoriteResponse403 | addFavoriteResponse404 | addFavoriteResponse409) & {
  headers: Headers;
};
...
export const getAddFavoriteUrl = (storeId: number,) => {
  ...
  return `/api/student/stores/${storeId}/favorites`
}
...
export type removeFavoriteResponseError = (removeFavoriteResponse403 | removeFavoriteResponse404) & {
  headers: Headers;
};
...
export const getCountFavoritesUrl = (storeId: number,) => {
  ...
  return `/api/student/stores/${storeId}/favorites/count`
}
...
export const getCountFavoritesQueryKey = (storeId?: number,) => {
    return [
    `/api/student/stores/${storeId}/favorites/count`
    ] as const;
    }
...
export type getMyFavoritesResponse403 = {
  data: SwaggerErrorResponse
  status: 403
}
...
export type getMyFavoritesResponseError = (getMyFavoritesResponse403) & {
  headers: Headers;
};

export type getMyFavoritesResponse = (getMyFavoritesResponseSuccess | getMyFavoritesResponseError)
...
export const getGetMyFavoritesUrl = (params: GetMyFavoritesParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/student/favorites?${stringifiedParams}` : `/api/student/favorites`
}
...
export const getGetMyFavoritesQueryKey = (params?: GetMyFavoritesParams,) => {
    return [
    `/api/student/favorites`, ...(params ? [params] : [])
    ] as const;
    }

    
export const getGetMyFavoritesQueryOptions = <TData = Awaited<ReturnType<typeof getMyFavorites>>, TError = SwaggerErrorResponse>(params: GetMyFavoritesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getMyFavorites>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetMyFavoritesQueryError = SwaggerErrorResponse


export function useGetMyFavorites<TData = Awaited<ReturnType<typeof getMyFavorites>>, TError = SwaggerErrorResponse>(
